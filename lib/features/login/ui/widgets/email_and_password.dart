...
import 'package:medical_app/features/login/ui/widgets/pass_validations.dart';
...
class _EmailAndPasswordState extends State<EmailAndPassword> {
  ...
  void initState() {
    super.initState();
    passwordController = context.read<LoginCubit>().passEditingController;
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          verticalSpacing(18),
          AppTextFormField(
            controller: context.read<LoginCubit>().passEditingController,
            hintText: 'Password',
